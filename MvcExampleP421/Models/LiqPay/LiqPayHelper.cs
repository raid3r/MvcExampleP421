...
namespace MvcExampleP421.Models.LiqPay
{
    public class LiqPayHelper
    {
        ...
        /// <returns></returns>
        static public LiqPayCheckoutFormModel GetLiqPayModel(string order_id, decimal amount)
        {
            ...
            var signature_source = new LiqPayCheckout()
            {
                ...
                result_url = "http://localhost:1274/Home/Redirect", // TODO
